...
public abstract class PreferenceFragment extends Fragment implements
	...
	/**
	 * Interface that PreferenceFragment's containing activity should implement to be able to process preference items
	 * that wish to switch to a new fragment.
	 */
	public interface OnPreferenceStartFragmentCallback {
		/**
		 * Called when the user has clicked on a Preference that has a fragment class name associated with it. The
		 * implementation to should instantiate and switch to an instance of the given fragment.
		 */
