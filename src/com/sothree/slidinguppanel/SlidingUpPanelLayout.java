...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	/**
	 * The size of the overhang in pixels that the panel and back should overlap in case of transparent panel
	 * background.
	 */
	private int mOverdrawHeight = -1;
	...
	/**
	 * Flag indicating if a drag view can have its own touch events. If set to true, a drag view can scroll horizontally
	 * and have its own click listener.
	 * 
	...
	/**
	 * Stores whether or not the pane was expanded the last time it was slideable. If expand/collapse operations are
	 * invoked this state is modified. Used by instance state save/restore.
	 */
	...
	public interface PanelSlideListener {
		...
		/**
		 * Called when a sliding pane becomes slid completely collapsed. The pane may or may not be interactive at this
		 * point depending on if it's shown or hidden
		 * 
		 * @param panel
		...
		/**
		 * Called when a sliding pane becomes slid completely expanded. The pane is now guaranteed to be interactive. It
	...
	/**
	 * No-op stubs for {@link PanelSlideListener}. If you only want to implement a subset of the listener methods you
	 * can extend this instead of implement the full interface.
	 */
	...
	public int getOverdrawHeight() {
		return mOverdrawHeight;
	}

	public void setOverdrawHeight(int mOverdrawHeight) {
		this.mOverdrawHeight = mOverdrawHeight;
		requestLayout();
	}
	 ...
	 * 
	 * @param anchorPoint
	 *            A value between 0 and 1, determining the position of the anchor point starting from the top of the
	 *            layout.
	 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int overdrawHeight = mOverdrawHeight;
	...
	/**
	 * Set if the drag view can have its own touch events. If set to true, a drag view can scroll horizontally and have
