...
public class UnifiedPreferenceHelper {
	...
	public boolean isSinglePane() {
		if (mSinglePane == null) {
			mSinglePane = Boolean.valueOf(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB
					|| !mActivity.onIsMultiPane() || mActivity.onIsHidingHeaders());
		}
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		if (isSinglePane()) {
			...
			// Set PreferenceManager options if the activity received them
			// before onPostCreate
			...
			// Add all preferences, first create a new preference screen if
			// necessary
