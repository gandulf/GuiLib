...
public class ColorPickerDialog extends AlertDialog {
	...
	private static class ColorPickerView extends View {
		...
		ColorPickerView(Context c, OnColorChangedListener l, int color) {
			super(c);
			mListener = l;
			mColors = new int[] { 0xFFFFFFFF, 0xFF000000, 0xFFFF0000, 0xFFFF00FF, 0xFF0000FF, 0xFF00FFFF, 0xFF00FF00,
		...
		protected void onSizeChanged(int w, int h, int oldw, int oldh) {
			...
			CENTER_X = Math.min(w, h) / 2;
			CENTER_Y = Math.min(w, h) / 2;

			mPaint.setStrokeWidth((int) (CENTER_X * 0.5));
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener, int initialColor) {
		...
		setTitle(R.string.label_pick_a_color);
	}
