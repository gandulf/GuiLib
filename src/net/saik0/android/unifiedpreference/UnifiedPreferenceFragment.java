...
public abstract class UnifiedPreferenceFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Pseudo-inherit sharedPreferencesName and sharedPreferencesMode from
		// Activity
		...
		if (getArguments() != null) {
			...
			Log.e("UNIFIED_PREFERENCES", "Calling preference fragment without preferencesRes arguments");
		}
	}
