...
public class DraggableGridView extends ViewGroup implements View.OnTouchListener, View.OnClickListener,
	...
	public void onClick(View view) {
		if (enabled) {
			...
			if (onItemClickListener != null && getLastIndex() != -1)
				onItemClickListener.onItemClick(null, getChildAt(getLastIndex()), getLastIndex(), getLastIndex());
		}
	}
	...
	public boolean onLongClick(View view) {
		...
		if (index != -1) {
			if (getChildAt(index) instanceof Checkable) {
				((Checkable) getChildAt(index)).setChecked(true);
	...
	protected void animateGap(int target) {
		for (int i = 0; i < getChildCount(); i++) {
			...
			TranslateAnimation translate = new TranslateAnimation(Animation.ABSOLUTE, oldOffset.x, Animation.ABSOLUTE,
					newOffset.x, Animation.ABSOLUTE, oldOffset.y, Animation.ABSOLUTE, newOffset.y);
